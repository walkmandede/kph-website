                      ...
                      return DecoratedBox(
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                ...
                                fit:
                                    xHorizontal ? BoxFit.cover : BoxFit.cover)),
                      );
                    },
                  ),
                ),
                //glassy
                if (!xDarkThemeNow(context: context))
                  BackdropFilter(
                ...
                MyResponsiveBuilder(
                  horizontalBuilder: (xHorizontal) {
                    return CustomScrollView(
                      ...
                      slivers: <Widget>[
                        SliverAppBar(
                          pinned: xHorizontal ? false : true,
                          snap: true,
                          floating: true,
                          backgroundColor: Colors.transparent,
                          elevation: 0,
                          expandedHeight: homePageBloc
                              .state.homeHeaderBaseHeightFactor
                              .ofScreenHeight(context: context),
                          collapsedHeight: homePageBloc
                              .state.homeHeaderBaseHeightFactor
                              .ofScreenHeight(context: context),
